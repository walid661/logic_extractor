    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">{documentName}</h1>
            <p className="text-muted-foreground">Règles extraites de ce document</p>
          </div>
      ...
      <RuleDetailsDialog rule={selectedRule} open={detailsOpen} onOpenChange={setDetailsOpen} />
